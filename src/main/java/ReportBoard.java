...
public class ReportBoard {
    ...
    public static void menu() {
        ...
        System.out.println("2. Вывести расшифровку по всем доходам и расходам");
        System.out.println("3. Вывести расшифровку расходов за промежуток времени, указанный пользователем");
